...
pacman_dir = os.path.join('/',*dirname.split('/')[:-3])
sys.path.append(pacman_dir)
import pacman2020
...
# confluence_server_url = 'https://innerspace.stsci.edu/'
# confluence_server_user = 'myawesomeuser@example.com'
# confluence_server_pass = 'myapikey'
# (or for confluence server)
confluence_server_url = 'https://innerspace.stsci.edu/'
confluence_server_user = 'nmiles'
confluence_server_pass = 'XdrCftVgyBhu2357!!'
